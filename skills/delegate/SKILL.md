...
6. **Monitoring** — is the built-in Monitor running for this session? An un-monitored dispatch is a doctrine violation (see § Recovery → Stall Watchdog in `grand-admiral`).
