...
5. Use `mindojo:search-standards` (if available) to query coding and security standards beyond local references. Use `mindojo:list-collections` first to discover valid filter values.
