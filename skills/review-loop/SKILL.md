...
user-invocable: true
allowed-tools: Read, Grep, Glob, Edit, Write, Bash(gh api repos/*/pulls/*/requested_reviewers *), Bash(gh api repos/*/pulls/*/reviews *), Bash(gh api repos/*/pulls/*/comments *), Bash(git add *), Bash(git commit *), Bash(git push *), Bash(git diff *), Bash(git log *), Bash(git status *)
---
