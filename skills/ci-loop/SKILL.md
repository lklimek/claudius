...
user-invocable: true
allowed-tools: Read, Grep, Glob, Edit, Write, Bash(gh run list *), Bash(gh run view *), Bash(gh run watch *), Bash(git add *), Bash(git commit *), Bash(git push *), Bash(git branch *), Bash(git diff *), Bash(git log *), Bash(git status *)
---
